...
import { KEY_CODES, COMPONENT_NAMES } from '../const';
...
export default class Cropper extends Component {
  ...
  private _cropzone:any = null;

  private _startX: number;
  private _startY: number;

  private _withShiftKey: boolean;
  ...
  constructor(graphics) {
    ...
    super(COMPONENT_NAMES.CROPPER, graphics);  
    this._cropzone = null;
    this._startX = null;
    this._startY = null;
    ...
    _getPresetCropSizePosition(presetRatio) {
        ...
        let width: number = standardSize * presetRatio;
        let height = standardSize;

        const scaleWidth: number = getScale(width, originalWidth);
        [width, height] = mapArrayOrNot([width, height], (sizeValue: number) => sizeValue * scaleWidth) as number[];
